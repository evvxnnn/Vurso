...
const MENU_ITEMS: MenuItem[] = [
  ...
  { id: 'lun-2', name: 'Beef Tips', description: 'Filet chunks grilled to order.', price: '$23', numPrice: 23, category: 'Lunch' },
  { id: 'lun-3', name: 'Smothered Prime Rib', description: 'With sautéed onions, mushrooms, and mozzarella.', price: '$28', numPrice: 28, category: 'Lunch', tag: 'Popular' },
  { id: 'lun-4', name: 'Fried Grouper Sandwich', description: 'Crispy grouper with Boom Boom sauce.', price: '$22', numPrice: 22, category: 'Lunch' },
  { id: 'lun-5', name: 'Tenderloin', description: 'Grilled or breaded pork tenderloin sandwich.', price: '$17', numPrice: 17, category: 'Lunch' },
  { id: 'lun-6', name: "Bynum's Club", description: 'Ham, turkey, bacon, chipotle mayo on sourdough.', price: '$16', numPrice: 16, category: 'Lunch' },
  { id: 'lun-7', name: 'Chicken Breast Sandwich', description: 'Cajun, bleu cheese, or BBQ sauce options.', price: '$14', numPrice: 14, category: 'Lunch' },
  { id: 'lun-8', name: 'Hot Ham & Cheese', description: 'American and mozzarella blend on grilled bread.', price: '$16', numPrice: 16, category: 'Lunch' },
  { id: 'lun-9', name: 'Roast Beef & Cheddar', description: 'Prime rib with melted cheddar.', price: '$18', numPrice: 18, category: 'Lunch' },
  { id: 'lun-10', name: 'Bleu Cheese Burger', description: 'Half pound patty with bleu cheese dressing.', price: '$16', numPrice: 16, category: 'Lunch' },
  ...
  { id: 'lun-13', name: 'Lunch Chopped Steak', description: 'Fresh ground filet, served until 4 PM.', price: '$19', numPrice: 19, category: 'Lunch' },
  { id: 'lun-14', name: 'Lunch Chicken Parmesan', description: 'Breaded with marinara on hoagie roll.', price: '$17', numPrice: 17, category: 'Lunch' },
